...
/**
 * @deprecated Use {@link bazaar4idea.repo.BzrRemote} to work with remotes. Use {@link BzrRepository#getConfig#getRemotes()} to get the list
 * of remotes.
 * 
 * A git remotes
 */
public final class BzrDeprecatedRemote {
  /**
   ...
   * @param url  the url
   */
  public BzrDeprecatedRemote(@NotNull final String name, final String url) {
    this(name, url, url);
  }
   ...
   */
  public BzrDeprecatedRemote(String name, String fetchUrl, String pushUrl) {
    myName = name;
    myFetchUrl = fetchUrl;
    myPushUrl = pushUrl;
  }
  ...
  public boolean equals(final Object obj) {
    return (obj instanceof BzrDeprecatedRemote) && myName.equals(((BzrDeprecatedRemote)obj).myName);
  }
   ...
   */
  public static List<BzrDeprecatedRemote> parseRemoteListInternal(String output) {
    ArrayList<BzrDeprecatedRemote> remotes = new ArrayList<BzrDeprecatedRemote>();
    ...
    while (s.hasMoreData()) {
      ...
      if (name != null && !n.equals(name) && fetch != null) {
        ...
        remotes.add(new BzrDeprecatedRemote(name, fetch, push));
        fetch = null;
        push = null;
      }
      name = n;
   ...
   */
  public static BzrDeprecatedRemote parseRemoteInternal(String name, String output) {
    ...
    return new BzrDeprecatedRemote(name, fetch, push);
  }
  ...
  public static List<String> getFetchSpecs(Project project, VirtualFile root, String remoteName) throws VcsException {
    ...
    @NonNls final File remotesFile = new File(rootFile, BzrUtil.DOT_BZR + File.separator + "remotes" + File.separator + remoteName);
    ...
    if (remotesFile.exists() && !remotesFile.isDirectory()) {
      ...
      // try .git/config file
      for (Pair<String, String> pair : BzrConfigUtil.getAllValues(project, root, "remote." + remoteName + ".fetch")) {
        rc.add(pair.second);
      }
    }
    return rc;
  ...
  public class Info {
     ...
     */
    public BzrDeprecatedRemote remote() {
      return BzrDeprecatedRemote.this;
    }
