...
public class BzrFileRevision extends VcsFileRevisionEx implements Comparable<VcsFileRevision>, VcsFileRevisionDvcsSpecific {

  @NotNull private final Project myProject;
  @NotNull private final FilePath myPath;
  @NotNull private final BzrRevisionNumber myRevision;
  ...
  public BzrFileRevision(@NotNull Project project, @NotNull FilePath path, @NotNull BzrRevisionNumber revision) {
    this(project, path, revision, null, null, null, null, Collections.<String>emptyList());
  }

  public BzrFileRevision(@NotNull Project project,
  ...
  public int compareTo(VcsFileRevision rev) {
    if (rev instanceof BzrFileRevision) return myRevision.compareTo(((BzrFileRevision)rev).myRevision);
