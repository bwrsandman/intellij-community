 ...
 */
public abstract class BzrReference implements Comparable<BzrReference> {

  @NotNull protected final String myName;

  public BzrReference(@NotNull String name) {
  ...
  public boolean equals(Object obj) {
    ...
    return obj instanceof BzrReference && getFullName().equals(((BzrReference)obj).getFullName());
  }
  ...
  public int compareTo(BzrReference o) {
