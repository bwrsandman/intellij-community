 ...
 */
public abstract class BzrRemoteBranch extends BzrBranch {

  protected BzrRemoteBranch(@NotNull String name, @NotNull Hash hash) {
    super(name, hash);
  }
  ...
  @NotNull
  public abstract BzrRemote getRemote();
