 ...
 */
public class BzrTag extends BzrReference {
  /**
   ...
   */
  public BzrTag(@NotNull String name) {
    super(name);
  }
   ...
   * @throws VcsException if there is a problem with running git
   */
  public static void list(final Project project, final VirtualFile root, final Collection<? super BzrTag> tags) throws VcsException {
    ArrayList<String> temp = new ArrayList<String>();
    listAsStrings(project, root, temp, null);
    for (String t : temp) {
      tags.add(new BzrTag(t));
    }
  }
}
