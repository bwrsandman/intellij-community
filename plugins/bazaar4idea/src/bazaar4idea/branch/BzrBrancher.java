...
/**
 * <p>Executes various operations on Bazaar branches: checkout, create new branch, merge, delete, compare.</p>
 * <p>All operations are asynchronous and can be called from the EDT: the BzrBrancher will start a background task.</p>
...
public interface BzrBrancher {
   ...
   */
  void checkoutNewBranch(@NotNull String name, @NotNull List<BzrRepository> repositories);
   ...
   */
  void createNewTag(@NotNull String name, @NotNull String reference, @NotNull List<BzrRepository> repositories,
   ...
   *                       If given, it will be called in the EDT {@link javax.swing.SwingUtilities#invokeLater(Runnable) later}.
   */
  void checkout(@NotNull String reference, @NotNull List<BzrRepository> repositories, @Nullable Runnable callInAwtLater);
   ...
   *                       If given, it will be called in the EDT {@link javax.swing.SwingUtilities#invokeLater(Runnable) later}.
   */
  void checkoutNewBranchStartingFrom(@NotNull String newBranchName, @NotNull String startPoint, @NotNull List<BzrRepository> repositories,
                                     @Nullable Runnable callInAwtLater);
   ...
   * @param repositories repositories to operate on.
   */
  void deleteBranch(@NotNull String branchName, @NotNull List<BzrRepository> repositories);
   ...
   * @param repositories Repositories to operate on.
   */
  void deleteRemoteBranch(@NotNull String branchName, @NotNull List<BzrRepository> repositories);
   ...
   */
  void compare(@NotNull String branchName, @NotNull List<BzrRepository> repositories, @NotNull BzrRepository selectedRepository);
   ...
   * @param repositories  repositories to operate on.
   */
  void merge(@NotNull String branchName, @NotNull DeleteOnMergeOption deleteOnMerge, @NotNull List<BzrRepository> repositories);
