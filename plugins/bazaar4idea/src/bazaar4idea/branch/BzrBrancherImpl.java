 ...
 */
class BzrBrancherImpl implements BzrBrancher {
  ...
  BzrBrancherImpl(@NotNull Project project, @NotNull BzrPlatformFacade facade, @NotNull Bzr bzr) {
    myProject = project;
    myFacade = facade;
    myBzr = bzr;
  }
  ...
  private BzrBranchWorker newWorker(ProgressIndicator indicator) {
    return new BzrBranchWorker(myProject, myFacade, myBzr, new BzrBranchUiHandlerImpl(myProject, myFacade, myBzr, indicator));
  }
  ...
  @Override
  public void checkout(@NotNull final String reference, @NotNull final List<BzrRepository> repositories,
                       @Nullable Runnable callInAwtLater) {
  ...
  public void checkoutNewBranchStartingFrom(@NotNull final String newBranchName, @NotNull final String startPoint,
                                            @NotNull final List<BzrRepository> repositories, @Nullable Runnable callInAwtLater) {
