 ...
 */
public class BzrSmartOperationDialog extends DialogWrapper {
  ...
  static int showAndGetAnswer(@NotNull final Project project, @NotNull final List<Change> changes, @NotNull final String operationTitle,
    ...
    UIUtil.invokeAndWaitIfNeeded(new Runnable() {
      @Override
      public void run() {
        BzrSmartOperationDialog dialog = new BzrSmartOperationDialog(project, changes, operationTitle, forceButton);
  ...
  private BzrSmartOperationDialog(@NotNull Project project,
  ...
  protected String getDimensionServiceKey() {
    return BzrSmartOperationDialog.class.getName();
  }
