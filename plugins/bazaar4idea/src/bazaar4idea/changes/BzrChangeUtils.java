...
public class BzrChangeUtils {
  /**
   * the pattern for committed changelist assumed by {@link #parseChangeList(com.intellij.openapi.project.Project,com.intellij.openapi.vfs.VirtualFile, bazaar4idea.util.StringScanner,boolean)}
   */
  ...
  /**
   * Get list of changes. Because native Bazaar non-linear revision tree structure is not
   ...
   * @throws VcsException in case of problem with running Bazaar
   */
  ...
  public static Collection<Change> getDiff(@NotNull Project project, @NotNull VirtualFile root,
    ...
    String range;
    BzrRevisionNumber newRev;
    BzrRevisionNumber oldRev;
  ...
  public static String getDiffOutput(@NotNull Project project, @NotNull VirtualFile root,
    ...
    BzrSimpleHandler handler = getDiffHandler(project, root, diffRange, dirtyPaths);
  ...
  @NotNull
  private static BzrSimpleHandler getDiffHandler(@NotNull Project project, @NotNull VirtualFile root,
