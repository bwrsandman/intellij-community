...
/**
 * Untracked files in Bazaar are not queried within the normal refresh procedure - they are watched separately.
 ...
 */
public class BzrChangesViewRefresher implements ChangesViewRefresher {

  @Override
  public void refresh(@NotNull Project project) {
    BzrRepositoryManager repositoryManager = ServiceManager.getService(project, BzrRepositoryManager.class);
    for (BzrRepository repository : repositoryManager.getRepositories()) {
