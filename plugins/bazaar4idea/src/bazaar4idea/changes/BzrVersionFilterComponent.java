 ...
 */
public class BzrVersionFilterComponent extends StandardVersionFilterComponent<ChangeBrowserSettings> {
   ...
   */
  public BzrVersionFilterComponent(boolean showDateFilter) {
