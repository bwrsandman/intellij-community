 ...
 */
class BzrUserNameNotDefinedDialog extends DialogWrapper {
  ...
  BzrUserNameNotDefinedDialog(@NotNull Project project,
    ...
    setTitle("Bazaar User Name Is Not Defined");
  ...
  protected ValidationInfo doValidate() {
    String message = "You have to specify user name and email for Bazaar";
  ...
  private String getMessageText() {
    ...
    String text = "Bazaar user.name and user.email properties are not defined in " + StringUtil.pluralize("root", myRootsWithUndefinedProps.size()) + "<br/>";
