...
/**
 * This class represents the result of a Bazaar command execution.
 *
 * @author Kirill Likhodedov
 */
public class BzrCommandResult {
  ...
  public BzrCommandResult(boolean success,
                          int exitCode,
  ...
  @NotNull
  public static BzrCommandResult error(@NotNull String error) {
    return new BzrCommandResult(false, 1, Collections.singletonList(error), Collections.<String>emptyList(), null);
  }
}
