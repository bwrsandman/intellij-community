 ...
 */
public class BzrLineHandler extends BzrTextHandler {
  /**
   ...
   * Line listeners
   */
  private final EventDispatcher<BzrLineHandlerListener> myLineListeners = EventDispatcher.create(BzrLineHandlerListener.class);
  ...
  public BzrLineHandler(@NotNull Project project, @NotNull File directory, @NotNull BzrCommand command) {
   ...
   * @param command a command to execute
   */
  public BzrLineHandler(@NotNull final Project project, @NotNull final VirtualFile vcsRoot, @NotNull final BzrCommand command) {
   ...
   */
  public void addLineListener(BzrLineHandlerListener listener) {
