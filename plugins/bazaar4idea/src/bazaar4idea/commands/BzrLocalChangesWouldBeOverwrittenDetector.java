 ...
 *
 * <p>Using a separate detector class instead of defining just an {@link BzrMessageWithFilesDetector.Event},
 * because older versions of Bazaar have other format of displaying this error that doesn't match any existing detectors.</p>
 *
 * @author Kirill Likhodedov
 */
public class BzrLocalChangesWouldBeOverwrittenDetector extends BzrMessageWithFilesDetector {
  ...
  public BzrLocalChangesWouldBeOverwrittenDetector(@NotNull VirtualFile root, @NotNull Operation operation) {
