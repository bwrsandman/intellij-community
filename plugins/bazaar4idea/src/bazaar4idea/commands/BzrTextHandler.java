 ...
 */
public abstract class BzrTextHandler extends BzrHandler {
  ...
  protected BzrTextHandler(@NotNull Project project, @NotNull File directory, @NotNull BzrCommand command) {
    super(project, directory, command);
  }

  protected BzrTextHandler(final Project project, final VirtualFile vcsRoot, final BzrCommand command) {
    ...
    myHandler.addProcessListener(new ProcessListener() {
      ...
      public void processTerminated(final ProcessEvent event) {
        ...
        try {
          ...
          cleanupEnv();
          BzrTextHandler.this.processTerminated(exitCode);
        } finally {
      ...
      public void onTextAvailable(final ProcessEvent event, final Key outputType) {
        BzrTextHandler.this.onTextAvailable(event.getText(), outputType);
      }
    });
