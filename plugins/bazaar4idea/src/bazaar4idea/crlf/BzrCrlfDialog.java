...
import static bazaar4idea.crlf.BzrCrlfUtil.*;
 ...
 * @see BzrCrlfProblemsDetector
 */
public class BzrCrlfDialog extends DialogWrapper {
  ...
  public BzrCrlfDialog(@Nullable Project project) {
    super(project, false);
  ...
  protected JComponent createCenterPanel() {
    JLabel description = new JBLabel(
      "<html>You are about to commit CRLF line separators to the Bazaar repository.<br/>" +
      "It is recommended to set core.autocrlf Bazaar attribute to <code>" + RECOMMENDED_VALUE +
      "</code> to avoid line separator issues.</html>");

    JLabel additionalDescription = new JBLabel(
      "<html>Fix and Commit: <code>bzr config --global core.autocrlf " + RECOMMENDED_VALUE + "</code> will be called,<br/>" +
  ...
  protected String getHelpId() {
    return "reference.VersionControl.Bazaar.CrlfWarning";
  }
