 ...
 */
class BzrLogStatusInfo {
  
  private final BzrChangeType myType;
  private final String myPath;
  private final String mySecondPath;

  BzrLogStatusInfo(@NotNull BzrChangeType type, @NotNull String path, @Nullable String secondPath) {
