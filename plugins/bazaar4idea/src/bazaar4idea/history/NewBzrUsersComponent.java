 ...
 * @author irengrig
 */
public class NewBzrUsersComponent {
  private final Object myLock = new Object();
  private SmallMapSerializer<String, List<String>> myState;
  private final File myFile;

  public NewBzrUsersComponent(final Project project) {
  ...
  public static NewBzrUsersComponent getInstance(final Project project) {
    return PeriodicalTasksCloser.getInstance().safeGetService(project, NewBzrUsersComponent.class);
  }
