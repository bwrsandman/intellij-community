 ...
 * It will be removed.
 * {@link bazaar4idea.BzrCommit} should be used instead.
 */
@Deprecated
public class BzrHeavyCommit {
  ...
  private final Set<BzrHeavyCommit> myParentsLinks;
  ...
  public BzrHeavyCommit(@NotNull VirtualFile root,
                        @NotNull final AbstractHash shortHash,
    ...
    //myBranches = branches;
    myParentsLinks = new HashSet<BzrHeavyCommit>();
  }

  public void addParentLink(final BzrHeavyCommit commit) {
  ...
  // todo think of interface
  public Set<BzrHeavyCommit> getParentsLinks() {
  ...
  public boolean equals(Object o) {
    ...
    BzrHeavyCommit gitCommit = (BzrHeavyCommit)o;
