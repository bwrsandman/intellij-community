...
public interface LowLevelAccess {
  ...
  void loadCommits(final Collection<String> startingPoints,
                   ...
                   final AsynchConsumer<BzrHeavyCommit> consumer,
                   int useMaxCnt,
  ...
  List<BzrHeavyCommit> getCommitDetails(final Collection<String> commitIds, SymbolicRefsI refs) throws VcsException;
}
