...
public class BzrLogSettings implements PersistentStateComponent<BzrLogSettings.MyState> {
  ...
  public static BzrLogSettings getInstance(final Project project) {
    return ServiceManager.getService(project, BzrLogSettings.class);
  }
