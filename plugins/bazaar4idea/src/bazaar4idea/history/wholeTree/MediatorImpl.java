...
public class MediatorImpl implements Mediator {
  ...
  public MediatorImpl(final Project project, BzrCommitsSequentially bzrCommitsSequentially) {
    myProject = project;
  ...
  public void reloadSetFixed(final Map<AbstractHash, Long> starred, final RootsHolder rootsHolder) {
    ...
    if (! missing.isEmpty()) {
      final BzrLogFilters filters =
        new BzrLogFilters(null, null, null, null, ObjectsConvertor.convert(missing, new Convertor<AbstractHash, String>() {
          @Override
  ...
  public void reload(final RootsHolder rootsHolder,
                     ...
                     Collection<String> endPoints, final BzrLogFilters filters, final boolean topoOrder) {
    myTicket.increment();
  ...
  @NonNls public static final String BAZAAR_LOG_PAGE_SIZE = "bzr.log.page.size";
  public static final int ourDefaultPageSize = 1000;
  public final static int ourManyLoadedStep = (! pageSizeOk(Integer.getInteger(BAZAAR_LOG_PAGE_SIZE))) ? ourDefaultPageSize : Integer.getInteger(
    BAZAAR_LOG_PAGE_SIZE);
  ...
  private static class SequenceSupportBuffer {
    ...
    private final BzrCommitsSequentially myCommitsSequentially;
    private final VirtualFile myRoot;

    private SequenceSupportBuffer(TableWrapper tableWrapper, BzrCommitsSequentially commitsSequentially, final VirtualFile root) {
