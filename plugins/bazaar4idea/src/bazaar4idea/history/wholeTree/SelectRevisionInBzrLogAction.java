 ...
 * @author rachinskiy
 */
public class SelectRevisionInBzrLogAction extends DumbAwareAction {

  public SelectRevisionInBzrLogAction() {
    super(BzrBundle.getString("vcs.history.action.bzrlog"), BzrBundle.getString("vcs.history.action.bzrlog"), null);
  }
