 ...
 */
class BzrRebaseEntry {
  /**
   * the logger
   */
  private static final Logger log = Logger.getInstance(BzrRebaseEntry.class.getName());
  /**
   * The commit hash
   */
   ...
   */
  public BzrRebaseEntry(final String commit, final String subject) {
    myCommit = commit;
    mySubject = subject;
  }
