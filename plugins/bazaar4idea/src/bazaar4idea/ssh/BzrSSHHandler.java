...
/**
 * An interface for Bazaar SSH handler
 */
public interface BzrSSHHandler {
  /**
   * The prefix of the ssh script name
   */
  @NonNls String BZR_SSH_PREFIX = "bzr-ssh-";
  /**
   * Name of environment variable for SSH handler number
   */
  @NonNls String SSH_HANDLER_ENV = "BAZAAR4IDEA_SSH_HANDLER";
  /**
   * Name of environment variable for SSH handler number
   */
  @NonNls String SSH_IGNORE_KNOWN_HOSTS_ENV = "BAZAAR4IDEA_SSH_IGNORE_KNOWN_HOSTS";
  /**
   * Name of environment variable for SSH handler
   */
  @NonNls String SSH_PORT_ENV = "BAZAAR4IDEA_SSH_PORT";
  /**
   * Name of environment variable for SSH executable
   */
  @NonNls String BAZAAR_SSH_ENV = "BAZAAR_SSH";
  /**
   * Name of the handler
   */
  @NonNls String HANDLER_NAME = "Bazaar4ideaSSHHandler";
