...
public class BzrSSHXmlRpcClient implements BzrSSHHandler {
  /**
   * XML RPC client
   */
   ...
   */
  BzrSSHXmlRpcClient(final int port, final boolean batchMode) throws IOException {
  ...
  private static String methodName(@NonNls final String method) {
    return BzrSSHHandler.HANDLER_NAME + "." + method;
  }
