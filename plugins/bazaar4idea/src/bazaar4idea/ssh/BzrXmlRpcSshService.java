 ...
 */
public class BzrXmlRpcSshService extends BzrXmlRpcHandlerService<BzrSSHGUIHandler> {

  private BzrXmlRpcSshService() {
    super(BzrSSHHandler.BZR_SSH_PREFIX, BzrSSHHandler.HANDLER_NAME, SSHMain.class);
  }
   ...
   */
  public class InternalRequestHandler implements BzrSSHHandler {
