 ...
 */
public class BzrShelveUtils {
  private static final Logger LOG = Logger.getInstance(BzrShelveUtils.class.getName());
  ...
  public static ShelvedChangeList shelveChanges(final Project project, final ShelveChangesManager shelveManager, Collection<Change> changes,
    ...
    try {
      ...
      project.getMessageBus().syncPublisher(ShelveChangesManager.SHELF_TOPIC).stateChanged(new ChangeEvent(BzrStashUtils.class));
      return shelve;
    }
    catch (IOException e) {
