 ...
 */
class BzrCompareBranchesDiffPanel extends JPanel {
  ...
  public BzrCompareBranchesDiffPanel(Project project, String branchName, String currentBranchName, BzrCommitCompareInfo compareInfo) {
    super();
