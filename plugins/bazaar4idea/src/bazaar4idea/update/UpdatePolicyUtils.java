...
public class UpdatePolicyUtils {
   ...
   */
  public static void updatePolicyItem(BzrVcsSettings.UpdateChangesPolicy updateChangesPolicy,
                                      JRadioButton stashRadioButton,
                                      JRadioButton shelveRadioButton) {
    switch (updateChangesPolicy == null ? BzrVcsSettings.UpdateChangesPolicy.STASH : updateChangesPolicy) {
      case STASH:
   ...
   */
  public static BzrVcsSettings.UpdateChangesPolicy getUpdatePolicy(@NotNull JRadioButton stashRadioButton,
                                                                   @NotNull JRadioButton shelveRadioButton) {

    if (stashRadioButton.isSelected()) {
      return BzrVcsSettings.UpdateChangesPolicy.STASH;
    } else if (shelveRadioButton.isSelected()) {
      return BzrVcsSettings.UpdateChangesPolicy.SHELVE;
    } else {
