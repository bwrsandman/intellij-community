 ...
 * It is a simple linear alternative to {@link bazaar4idea.update.BzrComplexProcess} performing tasks in a single method instead of
 * using continuations logic.
 *
 * @author Kirill Likhodedov
 */
public class BzrFreezingProcess {

  private static final Logger LOG = Logger.getInstance(BzrFreezingProcess.class);
  ...
  public BzrFreezingProcess(@NotNull Project project,
  ...
  public static void saveAndBlock(@NotNull BzrPlatformFacade platformFacade) {
  ...
  public static void unblock(@NotNull BzrPlatformFacade platformFacade) {
  ...
  private void freeze() {
    myChangeListManager.freezeImmediately("Local changes are not available until Bazaar " + myOperationTitle + " is finished.");
  }
