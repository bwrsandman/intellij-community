...
public class UntrackedFilesNotifier {
   ...
   * @param operation   the name of the Bazaar operation that caused the error: {@code rebase, merge, checkout}.
   * @param description the content of the notification or null if the deafult content is to be used.
   */
  public static void notifyUntrackedFilesOverwrittenBy(@NotNull final Project project, @NotNull BzrPlatformFacade platformFacade,
