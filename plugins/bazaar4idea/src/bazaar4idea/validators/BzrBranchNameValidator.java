...
/**
 * Bazaar branch name validator. The validation rule is based on what is described
 * git-check-ref-format(1) command description.  
 * 
 * @deprecated Use {@link BzrRefNameValidator}.
 */
public class BzrBranchNameValidator implements InputValidator {
  /**
   ...
   */
  public static final BzrBranchNameValidator INSTANCE = new BzrBranchNameValidator();
