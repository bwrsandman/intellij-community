...
/**
 * Checks that the specified String is a valid Bazaar reference name.
 ...
 */
public final class BzrRefNameValidator implements InputValidator {

  private static final BzrRefNameValidator INSTANCE = new BzrRefNameValidator();
  ...
  public static BzrRefNameValidator getInstance() {
    return INSTANCE;
  }

  private BzrRefNameValidator() {}
