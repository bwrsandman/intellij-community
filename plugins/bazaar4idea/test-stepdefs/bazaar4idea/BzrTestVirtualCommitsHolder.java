 ...
 * via hashes. We can't define a hash to the commit when committing to Bazaar, therefore to match these two sets we store them here.
 *
 * @author Kirill Likhodedov
 */
public class BzrTestVirtualCommitsHolder {
