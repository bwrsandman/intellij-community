...
import static bazaar4idea.BzrCucumberWorld.myNotificator;
import static bazaar4idea.BzrCucumberWorld.virtualCommits;
import static bazaar4idea.test.BzrExecutor.touch;
import static bazaar4idea.test.BzrScenarios.checkout;
...
public class GeneralStepdefs {
  ...
  public void new_committed_file(String filename, String content) throws Throwable {
    touch(filename, content);
    BzrExecutor.bzr("add %s", filename);
    BzrExecutor.bzr("commit -m 'adding %s'", filename);
  }
  ...
  public void new_committed_files_file_txt_a_txt_b_txt_with_initial_content(String listOfFiles) throws Throwable {
    ...
    BzrExecutor.bzr("add %s", StringUtil.join(files, " "));
    BzrExecutor.bzr("commit -m 'adding files with initial content'");
  }
  ...
  public void branch(String branchName) throws Throwable {
    BzrExecutor.bzr("branch " + branchName);
  }
