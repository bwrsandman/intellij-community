...
import bazaar4idea.DialogManager;
import org.jetbrains.annotations.NotNull;

import java.util.Map;

/**
 * <p>TestDialogManager instead of showing the dialog, gives the control to a {@link bazaar4idea.test.TestDialogHandler} which can specify the dialog exit code
 ...
 * <pre><code>
 *     myDialogManager.registerDialogHandler(BzrConvertFilesDialog.class, new TestDialogHandler<BzrConvertFilesDialog>() {
 *       &#064;Override public int handleDialog(BzrConvertFilesDialog dialog) {
 *         dialogShown.set(true);
 *         return BzrConvertFilesDialog.OK_EXIT_CODE;
 *       }
 *     });
 * </code></pre>
