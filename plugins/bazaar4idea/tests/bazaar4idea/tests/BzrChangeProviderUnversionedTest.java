...
import bazaar4idea.test.BzrTestRepository;
...
/**
 * Tests unversioned files tracking by the {@link bazaar4idea.status.BzrChangeProvider}.
 * This test is separate from {@link BzrChangeProviderTest}, because in the {@link bazaar4idea.status.BzrNewChangesCollector}
 * untracked files are handled separately by the {@link bazaar4idea.repo.BzrUntrackedFilesHolder}.
 *
 * @author Kirill Likhodedov
 * @deprecated Use {@link BzrLightTest}
 */
@Deprecated
public class BzrChangeProviderUnversionedTest extends BzrChangeProviderTest {
  ...
  public void create_folder_outside_makes_files_of_this_folder_unversioned() throws Exception {
    ...
    File file = BzrTestRepository.createFile(subdir, "newfile.txt", "");
    myRepo.refresh();
  ...
  private void prohibitAutoAdd() {
    setStandardConfirmation(BzrVcs.NAME, VcsConfiguration.StandardConfirmation.ADD, VcsShowConfirmationOption.Value.DO_NOTHING_SILENTLY);
  }
