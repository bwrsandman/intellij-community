 ...
 */
public class BzrStandardProgressAnalyzerTest {

  private static final double EPS = 0.00001;
  private BzrStandardProgressAnalyzer myProgressModifier;

  @Before
  public void setUp() {
    myProgressModifier = new BzrStandardProgressAnalyzer();
  }

  @Test
  public void returnMinusOneOnNonMatch() {
    assertEquals(myProgressModifier.analyzeProgress("From bzr@github.com:idea/community"), -1.0, EPS);
  }
  ...
  private double getCurrentTotalProgressAtTheEnd() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    for (Class cl : BzrStandardProgressAnalyzer.class.getDeclaredClasses()) {
    ...
    Method totalProgress = BzrStandardProgressAnalyzer.class.getDeclaredMethod("updateTotalProgress", operationClass);
