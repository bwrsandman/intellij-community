 ...
 */
package bazaar4idea.tests.rebase;
...
/**
 * NB: we don't test merge commits here, since {@link bazaar4idea.rebase.BzrRebaser#reoderCommitsIfNeeded(com.intellij.openapi.vfs.VirtualFile, String, java.util.List)}
 * is not suitable for this.
 * @author Kirill Likhodedov
 * @deprecated Use {@link BzrLightTest}
 */
@Deprecated
public class BzrRebaserReorderCommitsTest extends BzrTest {

  private BzrRebaser myRebaser;
  private VirtualFile myRoot;
  private String myFirstCommit;

  @BeforeMethod @Override protected void setUp(Method testMethod) throws Exception {
    super.setUp(testMethod);
    myRebaser = new BzrRebaser(myProject, ServiceManager.getService(Bzr.class), null);
